package com.hulahoopblue.green.auth.controller;

import com.hulahoopblue.green.auth.model.dto.LoginDTO;
import com.hulahoopblue.green.auth.model.service.AuthService;
...
public class AuthController {
    ...
    public String login(LoginDTO loginDTO, HttpSession session) {
        ...
        if(member == null || member.getUserTyp() != 3) {
